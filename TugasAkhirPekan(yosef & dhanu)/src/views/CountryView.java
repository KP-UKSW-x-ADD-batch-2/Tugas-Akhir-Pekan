...
public class CountryView extends javax.swing.JFrame {
    ...
    DbConnection connection = new DbConnection();
        ICountryDao icdao = new CountryDao((Connection) connection.getConnection());
        ...
        try {
            for (Country countgoin : icdao.getAll()) {

                String countID = countgoin.getCountryID();
                String countNM = countgoin.getCountryname();
                String countRegID = countgoin.getRegionID();
    ...
    private void searching() {
        ...
        Country countries = new Country(btn_search.getText());
...
//        Region r = new Region();
        ...
        try {
            for (Country countgoin : icdao.search(txt_search.getText())) {
//                System.out.println(regiong.getRegionId() + " || " + regiong.getRegionName());
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
       DbConnection connection = new DbConnection();
       ICountriesControllers icc = new CountriesControllers(connection.getConnection());
       Country countries = new Country(txt_countryId.getText(), txt_countryName.getText(), txt_regionID.getText());
    ...
    private void tabelcountriesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelcountriesMouseClicked
        ...
        txt_countryId.setText(source.getModel().getValueAt(i, 0)+"");
        txt_countryName.setText(source.getModel().getValueAt(i, 1)+"");
        txt_regionID.setText(source.getModel().getValueAt(i, 2)+"");
